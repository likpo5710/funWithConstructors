...
// -- ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ - Your Answer - ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ -- //
function Student(expertInput){
	this.expertise = expertInput
	this.knowledge = 0
}
...
var Safe = function(secretData, keyObj) {
...
Safe.prototype.unlock = function(keyObj) {
	return (this.getKey() === keyObj) ? this.getSecret() : null;
}
